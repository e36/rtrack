...
urlpatterns = [
                    ...
                    url(r'^accounts/change-password/$', auth_views.password_change, {'current_app': 'rtrack', 'template_name': 'registration/password_change_form.html'}, name='password_change'),
                    url(r'^accounts/password-change-done/$', auth_views.password_change_done,  {'current_app': 'rtrack', 'template_name': 'registration/password_change_done.html'}, name='password_change_done'),
