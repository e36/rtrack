...
urlpatterns = patterns('',
                       ...
                       url(r'user/(?P<user_name>\w+)/createnote/$', views.user_add_note_ajax,
                           name='create_user_note_ajax'),
                       url(r'user/(?P<user_name>\w+)/modmail_link/$', views.create_modmail_link,
                           name='create_modmail_link'),
                       url(r'user/(?P<user_name>\w+)/modmail_link/$', views.create_modmail_link_ajax,
                           name='create_modmail_link_ajax'),
