...
urlpatterns = [
                    ...
                    url(r'user/(?P<user_name>[-\w_]+)/$', views.user_page, name='user_page'),
                    url(r'user/(?P<user_name>[-\w_]+)/createnote/$', views.user_add_note, name='create_user_note'),
                    url(r'user/(?P<user_name>[-\w_]+)/createnote/$', views.user_add_note_ajax, name='create_user_note_ajax'),
                    url(r'user/(?P<user_name>[-\w_]+)/modmail_link/$', views.create_modmail_link, name='create_modmail_link'),
                    url(r'user/(?P<user_name>[-\w_]+)/modmail_link/$', views.create_modmail_link_ajax, name='create_modmail_link_ajax'),
